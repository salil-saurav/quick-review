...
$total_items    = get_total_count(true, QR_REVIEW_CAMPAIGN_ITEM, $post_id);
...
<div class="wrap review-wrap campaign-dashboard">
   <div class="review-container" id="url_table">
      ...
      <table class="review-table">
         ...
         <tbody class="review-list" data-total="<?= get_total_count(false, QR_REVIEW_CAMPAIGN_ITEM, $post_id) ?>">
            <?php render_table($page_data, QR_REVIEW_CAMPAIGN_ITEM, $post_id); ?>
         </tbody>
      </table>
